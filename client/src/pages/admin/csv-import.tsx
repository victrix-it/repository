...
export default function CsvImport() {
  ...
  const importMutation = useMutation({
    mutationFn: async (file: File) => {
      ...
      const response = await fetch('/api/configuration-items/csv/import', {
        method: 'POST',
        body: formData,
        credentials: 'include',
      });
    ...
    onSuccess: (data) => {
      ...
      if (data.success > 0) {
        toast({
          ...
          description: `Successfully imported ${data.success} configuration item${data.success > 1 ? 's' : ''}`,
        });
      }
    },
    onError: (error: any) => {
  ...
  const handleDownloadTemplate = () => {
    window.open('/api/configuration-items/csv/template', '_blank');
  };
  ...
  return (
    <div className="flex flex-col h-full p-6">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold" data-testid="text-page-title">CSV Import</h1>
        <p className="text-muted-foreground">
          Bulk import configuration items from a CSV file
        </p>
      </div>
      ...
      <div className="grid gap-6 max-w-4xl">
        ...
        <Card data-testid="card-upload-csv">
          <CardHeader>
            ...
            <CardDescription>
              Select your CSV file and click import to add configuration items
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            >
              {importMutation.isPending ? "Importing..." : "Import CIs"}
            </Button>
          </CardContent>
        </Card>
        ...
        {importResult && (
          <Card data-testid="card-import-results">
            ...
            <CardContent className="space-y-4">
              ...
              {importResult.success > 0 && (
                <Button
                  onClick={() => setLocation('/cmdb')}
                  data-testid="button-view-cmdb"
                >
                  View CMDB
                </Button>
              )}
          ...
          <CardContent className="space-y-3 text-sm">
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                <li><strong>Name</strong> - Configuration item name or hostname (required)</li>
                <li><strong>Type</strong> - server, application, database, network, storage, or other (required)</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                <li>Description</li>
                <li>Status (active, inactive, maintenance, decommissioned)</li>
                <li>IP Address</li>
                <li>Subnet Mask</li>
                <li>Serial Number</li>
                <li>Manufacturer</li>
            ...
            <Alert>
              <AlertCircle className="h-4 w-4" />
              <AlertDescription>
                Column names are case-insensitive and flexible. For example, "IP Address", "ip", "IP_Address" all work.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
